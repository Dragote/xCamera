 ...
 * override; the tick falls back to whatever the system setting allows. This intentionally has no
 * in-app haptics on/off preference of its own yet, so it can silently override the user's system
 * setting on API 33+.
 */
@Composable
